            ...
            <Col xs={24} sm={19}>
              <div className="top_intro_content">
                ...
                <Typography.Paragraph>
                  Chào mừng bạn đến với land use paper management - Nền tảng Truy Xuất, Cấp Mới, và Chuyển Nhượng Đất hiện đại và độc đáo. Chúng tôi tự hào giới thiệu một cách tiếp cận sáng tạo và đột phá trong việc quản lý, cấp mới và chuyển nhượng đất thông qua sự kết hợp của React JS và công nghệ Blockchain.                </Typography.Paragraph>
                <Button type='primary'>
          ...
          <Row gutter={16}>
            <Col xs={24} sm={12}>
              <div className="grid_item">
                ...
                <Typography.Paragraph>
                  Giao diện người dùng thân thiện của chúng tôi giúp bạn dễ dàng thực hiện các giao dịch liên quan đến đất đai chỉ trong vài bước đơn giản, truy cập thông tin và thực hiện giao dịch từ bất kỳ đâu, bất kỳ lúc nào.
                </Typography.Paragraph>
            ...
            <Col xs={24} sm={12}>
              <div className="grid_item">
                ...
                <Typography.Paragraph>
                  Cho phép bạn truy cập thông tin và thực hiện giao dịch từ bất kỳ đâu, bất kỳ lúc nào, Thực hiện các giao dịch cấp mới và chuyển nhượng đất đai một cách dễ dàng, Xem lịch sử giao dịch và cấp mới để đảm bảo tính minh bạch và tuân thủ quy định pháp luật.              </Typography.Paragraph>
                <Button type='primary'>Đọc thêm</Button>
              </div>
            </Col>
          </Row>
                ...
                <Row gutter={16}>
                  ...
                  <Col xs={24} sm={19}>
                    <div className="top_intro_content">
                      ...
                      <Typography.Paragraph>
                        Hãy đồng hành cùng chúng tôi trong hành trình hiện đại hóa quản lý tài sản đất đai. Nếu bạn có bất kỳ câu hỏi hoặc cần hỗ trợ, đừng ngần ngại liên hệ với chúng tôi tại <a href='Tel:0859734136'>xxx</a> hoặc qua <a href="mailto: trinhsytuan@gmail.com">trinhsytuan@gmail.com</a>. Chúng tôi luôn sẵn sàng để hỗ trợ bạn.                      </Typography.Paragraph>
                      <Button type='primary'>
